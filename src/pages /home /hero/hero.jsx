  ...
  return (
    <section className="hero flex flex-col md:flex-row items-center justify-center md:justify-between px-8 py-16 md:px-20 bg-gradient-to-br from-indigo-800 via-purple-700 to-pink-500 text-white min-h-screen">
      <div className="hero-content max-w-lg md:max-w-xl mb-8 md:mb-0 text-center md:text-left space-y-6">
        ...
        <a
          href="#projects"
          className="inline-block px-8 py-3 bg-gradient-to-r from-blue-400 to-blue-600 text-gray-900 font-semibold rounded-full shadow-lg transform transition hover:scale-105 hover:bg-gradient-to-l hover:shadow-2xl"
        >
          View My Work
        </a>
      </div>
      <div className="hero-image">
        <img
          src={profileImage}
          alt="Profile"
          className="w-64 h-64 md:w-80 md:h-80 rounded-full object-cover shadow-xl border-4 border-white transform transition-transform duration-300 hover:scale-110 hover:shadow-2xl"
        />
      </div>
    </section>
  );
